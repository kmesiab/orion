...
import AnalysisViewer from "../AnalysisViewer/AnalysisViewer";
...
const DiffViewer = ({ text, analysisReport, loading }) => {
  const [value, setValue] = useState("0");
  const files = parseDiff(text);

  if (!text) {
    return (
      <div className="diff-viewer">Enter a GitHub pull request URL 👆</div>
    );
  }
