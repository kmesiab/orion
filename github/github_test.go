...
func TestGetPullRequest(t *testing.T) {
	...
	assert.Len(t, gitDiffs, 1, "At least one Diff should have been parsed")
	assert.Equal(t, gitDiffs[0].FilePathOld, "a/README.md",
		"The [a] readme must have been identified")
	assert.Equal(t, gitDiffs[0].FilePathNew, "b/README.md",
		"The [b] readme must have been identified")
}
